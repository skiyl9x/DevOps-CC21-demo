...
AWS resourse  | Why?
------------- | -------------
[VPC](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html) | To create infrastructure network. I've used several `subnets` and one `NAT gateway`
