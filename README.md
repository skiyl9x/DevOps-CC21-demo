...
I've deployed `Vault` to `Kubernetes` cluster. Bash scripts for initializing `Vault` and adding new keys to `Vault` have been described in this [repository](https://github.com/skiyl9x/vault-k8s)
